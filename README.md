...
[![addon-console](https://img.shields.io/npm/dt/@hishprorg/nobis-libero.svg)](https://github.com/hishprorg/nobis-libero)
...
[![storybook-addon-console](https://raw.githubusercontent.com/hishprorg/nobis-libero/master/docs/storybook-addon-console.png)](https://raw.githubusercontent.com/hishprorg/nobis-libero/master/docs/storybook-addon-console.png)
...
```shell
yarn add -D @hishprorg/nobis-libero @storybook/addon-actions
```
...
import { setConsoleOptions } from '@hishprorg/nobis-libero';
...
import { withConsole } from '@hishprorg/nobis-libero';
...
## API
<a name="module_@hishprorg/nobis-libero"></a>

## @hishprorg/nobis-libero
...
* [@hishprorg/nobis-libero](#module_@hishprorg/nobis-libero)
    * _static_
        * [.setConsoleOptions(optionsOrFn)](#module_@hishprorg/nobis-libero.setConsoleOptions) ⇒ <code>addonOptions</code>
        * [.withConsole([optionsOrFn])](#module_@hishprorg/nobis-libero.withConsole) ⇒ <code>function</code>
    * _inner_
        * [~addonOptions](#module_@hishprorg/nobis-libero..addonOptions) : <code>Object</code>
        * [~optionsCallback](#module_@hishprorg/nobis-libero..optionsCallback) ⇒ <code>addonOptions</code>

<a name="module_@hishprorg/nobis-libero.setConsoleOptions"></a>

### @hishprorg/nobis-libero.setConsoleOptions(optionsOrFn) ⇒ <code>addonOptions</code>
Set addon options and returns a new one

**Kind**: static method of [<code>@hishprorg/nobis-libero</code>](#module_@hishprorg/nobis-libero)  
**See**
...
```
<a name="module_@hishprorg/nobis-libero.withConsole"></a>

### @hishprorg/nobis-libero.withConsole([optionsOrFn]) ⇒ <code>function</code>
...
```
<a name="module_@hishprorg/nobis-libero..addonOptions"></a>

### @hishprorg/nobis-libero~addonOptions : <code>Object</code>
This options could be passed to [withConsole](#storybookaddon-consolewithconsoleoptionsorfn--function) or [setConsoleOptions](#module_@hishprorg/nobis-libero.setConsoleOptions)

**Kind**: inner typedef of [<code>@hishprorg/nobis-libero</code>](#module_@hishprorg/nobis-libero)  
**Properties**
...
<a name="module_@hishprorg/nobis-libero..optionsCallback"></a>

### @hishprorg/nobis-libero~optionsCallback ⇒ <code>addonOptions</code>
